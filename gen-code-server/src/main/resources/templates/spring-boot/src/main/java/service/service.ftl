!#parse
!#name /src/main/java/${classInfo.basePackage()}.service/I${classInfo.name}Service.java
!#list

package ${classInfo.basePackage()}.service;
...
public interface I${classInfo.name}Service {
    ...
    * 查询
    */
    ${classInfo.name}Dto seletBy${classInfo.primaryKey.beanAttr.name?cap_first}(${classInfo.primaryKey.beanAttr.typeClassName} ${classInfo.primaryKey.beanAttr.name});
